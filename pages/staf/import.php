...
<div id="content-container">
    <div class="pageheader hidden-xs">
        <h3><i class="fa fa-home"></i> Import Staf </h3>
...
<div class="row">
    ...
    <div class="panel">
      <div class="panel-heading">
          ...
          <h3 class="panel-title">Import Staf
        ...
        <div class="row">
            <div class="col-lg-6 col-lg-6-offsett-3">
                ...
                if(isset($_POST['import'])) {
                    ...
                    $sql = "INSERT INTO tb_staf (kode, nama, posisi) VALUES";
                    for ($i=3; $i <= count($all_data); $i++) { 
                        $kode = $all_data[$i]['A'];
                        $nama = $all_data[$i]['B'];
                        $posisi = $all_data[$i]['C'];
                        $sql .= " ('$kode', '$nama', '$posisi'),";
                    }
                    $sql = substr($sql, 0, -1);
                    mysqli_query($koneksi, $sql) or die (mysqli_error($koneksi));
                    unlink($target_file);
                    echo "<script>window.location='?pages=staf';</script>"; 
                }
                ?>
            </div>
        </div>
