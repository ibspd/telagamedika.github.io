...
<div id="content-container">
    <div class="pageheader hidden-xs">
        <h3><i class="fa fa-home"></i> Obat-Obatan </h3>
      ...
      <div class="panel-heading">
          ...
          <h3 class="panel-title">Daftar Obat
            ...
            <div class="pull-right">
              ...
              <a href="?pages=obat&aksi=tambah" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-plus"></i>Tambah Obat</a>
              <a href="?pages=obat&aksi=import" class="btn btn-info btn-xs"><i class="glyphicon glyphicon-import"></i>Import Obat</a>
            </div>
            </h3>
      </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="right"> 
                ...
                <a href="?pages=obat&aksi=update&id=<?=$data['kode']?>" class="btn">
                    <i class="fa fa-edit"></i> Update
                </a>
                <a onclick="return confirm('Apakah anda yakin menghapus barang?')" href="?pages=obat&aksi=hapus&id=<?=$data['kode']?>" class="btn">
