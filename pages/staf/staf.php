...
<div id="content-container">
    <div class="pageheader hidden-xs">
        <h3><i class="fa fa-home"></i> Staf </h3>
...
<div class="row">
    ...
    <div class="panel">
      <div class="panel-heading">
          ...
          <h3 class="panel-title">Daftar Staf
          
            <div class="pull-right">
              <a href="" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-refresh"></i></a>
              <a href="?pages=prosedur&aksi=tambah" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-plus"></i>Tambah Staf</a>
              <a href="?pages=staf&aksi=import" class="btn btn-info btn-xs"><i class="glyphicon glyphicon-import"></i>Import Staf</a>
            </div>
            </h3>
      </div>
      ...
      <div class="panel-body">
        <table id="demo-dt-selection" class="table table-striped table-bordered">
          ...
          <?php
                $no = 1;
                $sql = $koneksi->query("SELECT * from tb_staf") or $koneksi->error;
                if(mysqli_num_rows($sql) > 0) {
                    ...
                    <tr>
                        ...
                        <td> 
                            ...
                            <a href="?pages=staf&aksi=update&id=<?=$data['kode']?>" class="btn">
                                <i class="fa fa-edit"></i> Update
                            </a>
                            <a onclick="return confirm('Apakah anda yakin menghapus barang?')" href="?pages=staf&aksi=hapus&id=<?=$data['kode']?>" class="btn">
