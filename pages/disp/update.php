...
<div id="content-container">
    <div class="pageheader hidden-xs">
        <h3><i class="fa fa-home"></i> Ubah Data Obat </h3>
        <div class="breadcrumb-wrapper">
            <span class="label">You are here:</span>
                <ol class="breadcrumb">
                <li> <a href="?home"> Home </a> </li>
                <li> <a href="?pages=obat"> Daftar Obat </a> </li>
                <li class="active"> Ubah Data Obat </li>
                </ol>
        </div>
    </div>
            ...
            <section class="panel">
                <form method="POST" enctype="multipart/form-data" class="form-horizontal form-bordered" action="#">
                    ...
                    <div class="panel-body np">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input name="nama" type="text" id="demo-text-input" class="form-control" value="<?=$tampil['nama']?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select name="jenis" class="form-control">
                                    <option value="Tablet" <?php if ($level=='Tablet') {echo "selected";}?>> Tablet</option>
                                    <option value="Injeksi" <?php if ($level=='Injeksi') {echo "selected";}?>>Injeksi</option>
                                    <option value="Sirup" <?php if ($level=='Sirup') {echo "selected";}?>>Sirup</option>
                                    <option value="Lain" <?php if ($level=='Lain') {echo "selected";}?>>Lain</option>
                                </select>
                            </div>
                            <label class="col-md-1 control-label" for="">Stok</label>
                            <div class="col-md-3">
                                <input name="stok" type="number" class="form-control" value="<?=$tampil['stok']?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input name="hdasar" type="number" id="harga_dasar" onkeyup="sum()" class="form-control" value="<?=$tampil['hdasar']?>">
                                <!-- <small class="help-block">This is a help text</small> -->
                            </div>
                            <label class="col-md-1 control-label" for="">Expired</label>
                            <div class="col-md-3">
                                <input name="expired" type="date" class="form-control" value="<?=$tampil['expired']?>">
                                <!-- <small class="help-block">This is a help text</small> -->
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input name="hlokal" type="number" id="hlokal" class="form-control" value="<?=$tampil['hlokal']?>" readonly> 
                                <small class="help-block">Harga Lokal</small>
                            </div>
                            <div class="col-md-2">
                                <input name="hexpat" type="number" id="hexpat" class="form-control" value="<?=$tampil['hexpat']?>" readonly>
                                <small class="help-block">Harga Expat</small>
                            </div>
                            <div class="col-md-2">
                                <input name="hasing" type="number" id="hasing" class="form-control" value="<?=$tampil['hasing']?>" readonly>
                                <small class="help-block">Harga Asing</small>
                            </div>
                            <div class="col-md-2">
                                <input name="hasu" type="number" id="hasu" class="form-control" value="<?=$tampil['hasu']?>" readonly>
                ...
                <?php 
                    if (isset($_POST['simpan'])) {
                        ...
                        $sql = $koneksi->query("UPDATE tb_obat SET nama='$nama', jenis='$jenis', hdasar='$hdasar', hlokal='$hlokal', hexpat='$hexpat', hasing='$hasing', hasu='$hasu', stok='$stok', expired='$expired' WHERE kode='$data' ");
                        if ($sql) {
                            ?>
